...
class DOMtest {
    public static void main(String[] argv) {
        ...
        try {
            ...
            /*
             * String s = "<?xml version='1.0' encoding=\"\"?>"+ //"ass\"?>"+ "<this><a xmlns=' abc ' xmlns:xmlnsls=\"a\" a=' &#xA; fsfs  '" +" xmlns:a='1'> &#xA; </a></this>";
             */
             ...
             * 
             * n = n.getFirstChild(); Element e1 = (Element) n; System.out.println(e1); n.normalize(); n = n.getFirstChild(); //System.out.println //.getFirstChild(); //n.normalize(); System.out.println(n); Attr a =
             * e1.getAttributeNode("a"); System.out.println(a.getValue());
             */
