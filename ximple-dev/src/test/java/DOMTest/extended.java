...
public class extended {
...

    {
        long count = 0;
        if (args.length != 1) {
            throw new IllegalArgumentException("Usage: Java " + extended.class.getName() + " <XMLFileName>");
        }
        ...
        try {
            ...
            if (vn.matchElement("ArticleSet") && vn.toElement(VTDNavHuge.FC, "Article")) {
                        ...
                        do {
                            if (vn.toElement(VTDNavHuge.FC, "Issn")) {
                                ...
                                do {
                                    ...
                                    System.out.println(count + " Issn: " + st);
                                    st = null;

                                } while (vn.toElement(VTDNavHuge.NS, "Issn"));
