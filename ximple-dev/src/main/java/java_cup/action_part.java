...
/**
 * This class represents a part of a production which contains an action. These are eventually
 * eliminated from productions and converted to trailing actions by factoring out with a production
 * that derives the empty string (and ends with this action).
 *
