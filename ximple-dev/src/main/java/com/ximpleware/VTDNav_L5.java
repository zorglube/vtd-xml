...
public class VTDNav_L5 extends VTDNav {
     ...
     */
    protected VTDNav_L5(int RootIndex, int enc, boolean NS, int depth, IByteBuffer x, FastLongBuffer vtd, FastLongBuffer l1, FastLongBuffer l2, FastLongBuffer l3, FastLongBuffer l4, FastIntBuffer l5, int so, // start offset of the starting
                                                                                                                                                                                                                // offset(in byte)
    ...
    public VTDNav cloneNav() {
        VTDNav_L5 vn = new VTDNav_L5(rootIndex, encoding, ns, nestingLevel - 1, XMLDoc, vtdBuffer, l1Buffer, l2Buffer, l3Buffer, l4Buffer, l5Buffer, docOffset, docLen);
    ...
    final public VTDNav duplicateNav() {
        return new VTDNav_L5(rootIndex, encoding, ns, nestingLevel - 1, XMLDoc, vtdBuffer, l1Buffer, l2Buffer, l3Buffer, l4Buffer, l5Buffer, docOffset, docLen);
    }
     ...
     */
    @Override
    final protected boolean iterateNS(int dp, String URL, String ln) throws NavException {
        if (!ns) {
            return false;
        }
        int tokenType;
    ...
    protected void resolveLC_l3() {
        ...
        if (l3index < 0 || l3index >= l3Buffer.size || context[3] != l3Buffer.upper32At(l3index)) {
            ...
            if (l3index + 1 < l3Buffer.size && context[3] == l3Buffer.upper32At(l3index + 1)) {
                ...
                int init_guess = l3lower + (int) ((l3upper - l3lower) * ((float) context[3] - l3Buffer.upper32At(l3lower)) / (l3Buffer.upper32At(l3upper) - l3Buffer.upper32At(l3lower)));
    ...
    private void resolveLC_l4() {
        ...
        if (l4index < 0 || l4index >= l4Buffer.size || context[4] != l4Buffer.upper32At(l4index)) {
            ...
            if (l4index + 1 < l4Buffer.size && context[4] == l4Buffer.upper32At(l4index + 1)) {
                ...
                int init_guess = l4lower + (int) ((l4upper - l4lower) * ((float) context[4] - l4Buffer.upper32At(l4lower)) / (l4Buffer.upper32At(l4upper) - l4Buffer.upper32At(l4lower)));
    ...
    private void resolveLC_l5() {
        ...
        if (l5index < 0 || l5index >= l5Buffer.size || context[5] != l5Buffer.intAt(l5index)) {
            if (l5index >= l5Buffer.size || l5index < 0) {
                l5index = l5lower;
            }
            if (l5index + 1 < l5Buffer.size && context[5] == l5Buffer.intAt(l5index + 1)) {
                l5index = l5index + 1;
            } else if (l5upper - l5lower >= 16) {
                int init_guess = l5lower + (int) ((l5upper - l5lower) * ((float) (context[5] - l5Buffer.intAt(l5lower)) / (l5Buffer.intAt(l5upper) - l5Buffer.intAt(l5lower))));
    ...
    protected void sync(int depth, int index) {
        ...
        default:
            if (l4Buffer.lower32At(l4index) != -1) {
                ...
                /*
                 * } else { while (context[5] != l5Buffer.intAt(l5index)){ l5index--; } }
                 */
...
//		fib.append(context);
    ...
    public boolean toElement(int direction) throws NavException {
        ...
        case LAST_CHILD:
            ...
            case 3:
                ...
                // System.out.println(" l2 upper: " + l2upper + " l2
                // lower : " + l2lower);
                l4index = direction == FIRST_CHILD ? l4lower : l4upper;
            ...
            case 4:
                ...
                // lower : " + l3lower);
                l5index = direction == FIRST_CHILD ? l5lower : l5upper;
    ...
    public void writeIndex(OutputStream os) throws IndexWriteException, IOException {
        IndexHandler.writeIndex_L5((byte) 1, encoding, ns, true, nestingLevel - 1, 5, rootIndex, XMLDoc.getBytes(), docOffset, docLen, vtdBuffer, l1Buffer, l2Buffer, l3Buffer, l4Buffer, l5Buffer, os);
    }
    ...
    public void writeSeparateIndex(OutputStream os) throws IndexWriteException, IOException {
        IndexHandler.writeSeparateIndex_L5((byte) 2, encoding, ns, true, nestingLevel - 1, 5, rootIndex, docOffset, docLen, vtdBuffer, l1Buffer, l2Buffer, l3Buffer, l4Buffer, l5Buffer, os);
    }
    ...
    protected boolean toNode_PrevSibling() {
        ...
        case 1:
            if (!atTerminal) {
                ...
                if (getTokenDepth(index) == 0 && tokenType != TOKEN_ATTR_VAL && tokenType != TOKEN_STARTING_TAG) {
                    ...
                    LN = index;
                    return true;
                } else // no more prev sibling element
                if (l1index != 0) {
                    l1index--;
                    context[1] = l1Buffer.upper32At(l1index);
                    return true;
        ...
        case 4:
            if (!atTerminal) {
                index = context[4] - 1;
                tokenType = getTokenType(index);
                if (getTokenDepth(index) == 3 && tokenType != TOKEN_ATTR_VAL && tokenType != TOKEN_STARTING_TAG) {
                    if (tokenType == TOKEN_PI_VAL) {
                        index--;
                    }
                    context[0] = 3;
        ...
        case 5:
            if (!atTerminal) {
                index = context[5] - 1;
                tokenType = getTokenType(index);
                if (getTokenDepth(index) == 4 && tokenType != TOKEN_ATTR_VAL && tokenType != TOKEN_STARTING_TAG) {
                    if (tokenType == TOKEN_PI_VAL) {
                        index--;
                    }
                    context[0] = 4;
    ...
    protected boolean toNode_LastChild() {
        ...
        case 3:
            if (l3Buffer.lower32At(l3index) != -1) {
                ...
                if (index >= vtdSize || getTokenDepth(index) != 3 || getTokenType(index) == VTDNav.TOKEN_STARTING_TAG) {
                    return false;
                }
                lastEntry = index;
                index++;
        ...
        if (atTerminal) {
            ...
            case 2:
                if (LN > context[2] && context[2] > context[1]) {
                    ...
                    if (i1 != -1) {
                        ...
                        if (l3index != l3upper && l3Buffer.upper32At(l3index) < LN) {
                            return false;
                        }
                    }
                    return true;
            ...
            case 3:
                if (LN > context[3] && context[3] > context[2] && context[2] > context[1]) {
                    ...
                    /*
                     * if (l3index != l3upper) { if (l3Buffer.upper32At(l3index) < LN) return false; }
                     */
                    // l4
                    ...
                    if (i1 != -1) {
                        ...
                        if (l4index != l4upper && l4Buffer.upper32At(l4index) < LN) {
                            return false;
                        }
                    }
                    return true;
            ...
            case 4:
                if (LN > context[3] && context[3] > context[2] && context[2] > context[1]) {
                    ...
                    /*
                     * if (l4index != l4upper) { if (l4Buffer.upper32At(l4index) < LN) return false; }
                     */
                    ...
                    if (i1 != -1) {
                        ...
                        if (l5index != l5upper && l5Buffer.intAt(l5index) < LN) {
                            return false;
                        }
                    }
                    return true;
            ...
            default:
                ...
                if (context[0] == 5) {
                    ...
                    if (l5index + 1 <= l5Buffer.size - 1 && l5Buffer.intAt(l5index + 1) < LN) {
                        return false;
                    }
                }
                return true;
            ...
            case 3 -> l1Buffer.upper32At(l1index) == context[1] && l2Buffer.upper32At(l2index) == context[2] && l3Buffer.upper32At(l3index) == context[3];
            case 4 -> l1Buffer.upper32At(l1index) == context[1] && l2Buffer.upper32At(l2index) == context[2] && l3Buffer.upper32At(l3index) == context[3] && l4Buffer.upper32At(l4index) == context[4];
            default ->
                l1Buffer.upper32At(l1index) == context[1] && l2Buffer.upper32At(l2index) == context[2] && l3Buffer.upper32At(l3index) == context[3] && l4Buffer.upper32At(l4index) == context[4] && l5Buffer.intAt(l5index) == context[5];
            };
