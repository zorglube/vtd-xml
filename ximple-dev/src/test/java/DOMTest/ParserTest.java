...
//
/* FIXME: Ignored because "c:/xml/pubmed_result.txt" isn't available */
...
//
//        if (vnh.matchElement("PubmedArticleSet") && vnh.toElement(VTDNavHuge.FC, "PubmedArticle")) {
//            do {
...
//            vnh.toElement(VTDNavHuge.P);
//        } // end of PubmedArticle if block// end of PubmedArticleSet if block
//
//    }// end of testParser()
//
